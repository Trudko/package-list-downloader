...
module.exports = {
  ...
  activate:function() {
    atom.commands.add('.workspace','package-list:load-predefined-list', this.loadPackageList);
    atom.commands.add('.workspace','package-list:load-custom-list', this.customPackageList);
  },
